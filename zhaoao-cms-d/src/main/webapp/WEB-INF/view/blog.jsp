	...
	<div class="container">
		<div class="row">
			<div class="col-md-8">
				...
				<hr/>
				<c:choose>
					<c:when test="${blog.articletype == '1'}">
						  ...
						  <div class="carousel-inner">
							<c:forEach items="${pictures}" var="picture" varStatus="idx">
								<div class="carousel-item ${idx.index==0 ? 'active' : ''}">
								  <img class="d-block w-100" src="${picture.photo}" alt="${picture.photo}">
			...
			<div class="col-md-4">
				<div class="panel panel-default">
				  ...
				  <div class="panel-body">
				  	<c:forEach items="${hotArticlesList}" var="blog">
				  	<li class="text-truncate"><a href="/article?id=${blog.id}">${blog.title}</a></li>
				  	</c:forEach>
				  </div>
				</div>

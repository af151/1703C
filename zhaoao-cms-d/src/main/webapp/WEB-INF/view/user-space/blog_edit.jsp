  ...
  <body>
			...
			<div class="col-md-9">
				<div class="panel panel-default">
				  <div class="panel-body">
				    	...
				    	<p>
				    		<textarea name="content" rows="20"  class="form-control" placeholder="内容">${blog.content }</textarea>
				    		<span class="red"></span>
				    	</p>
	...
	<script type="text/javascript">
		...
		$("#bTitle").click(function(){
			$("#title").attr("style",$("#title").attr("style")+" font-weight: bolder;");
			$("#style").val($("#title").attr("style"));
		})
					
				
		$("#iTitle").click(function(){
			$("#title").attr("style",$("#title").attr("style")+" font-style: italic;");
			$("#style").val($("#title").attr("style"));
		})
		
				
		$("#rTitle").click(function(){
			$("#title").attr("style",$("#title").attr("style")+" color: red;");
			$("#style").val($("#title").attr("style"));
		})
	</script>
  </body>

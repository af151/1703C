				...
				<div class="panel panel-default">
				  <div class="panel-body">
				   <h1>我的头像</h1>
				    	<hr/>
				    	<div>
				    		<img src="${pageContext.request.contextPath }${avatarpath}" alt="..." class="img-thumbnail">    	
				    	</div>
				    	<br/>
				    	<div>
					    	<form action="/my/profile/avatarsave" enctype="multipart/form-data" method="post" >
					    	<p align="center" class="red"> </p>
					    	<p>更换头像：<input type="file" name="file"/> </p>

...
import com.zhaoao.cms.service.PassportService;
import com.zhaoao.cms.utils.AssertUtil;
import com.zhaoao.cms.web.Constant;
import com.zhaoao.cms.web.forms.UserForm;
...
public class PassportController {
	...
	public String loginSubmit(@ModelAttribute UserForm userForm, Model model, HttpServletRequest request){
		try {
			...
			String avapath = user.getAvapath();
			request.getServletContext().setAttribute("avatarpath", avapath);
